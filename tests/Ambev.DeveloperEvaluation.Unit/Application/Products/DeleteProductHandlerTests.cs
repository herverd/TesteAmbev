...
public class DeleteProductHandlerTests
{
    ...
    /// <summary>
    /// Tests that an valid request when try to delete product not existing in database should throws a not found exception.
    /// </summary>
    [Fact(DisplayName = "Given valid product identifier When try delete not existing product Then should throws not found exception")]
